...
## How do we model a double pendulum mathematically?
...
One simple choice is to model the system as two point masses connect via rigid massless links
as illustrated below.

<!-- we can describe the con of a system
The state of a double pendulum at a given time, $t$ can be described by two variables.
...
This model is a good start, but still doesn't tell us how the system changes over time. To do that,
...
how to compute the cartesian coordinates of the point masses, since computer graphics APIs
